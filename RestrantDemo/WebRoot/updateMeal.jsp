		...
		<table width="90%" height="170" border="0" cellpadding="0"
			...
			<tr>
				...
				<td valign="top" width="80%">
					...
					<br />
					<s:form action="doUpdateMeal" method="post" enctype="multipart/form-date">
						<table align="center">
							<s:hidden name="meal.mealId" value="%{#request.updatedMeal.mealId}"></s:hidden>
							<s:textfiled name="meal.mealName" lable="菜名" value="%{#request.updatedMeal.mealName}" />
							...
							<s:textfield name="meal.mealSummarize" lable="摘要" value="%{#request.updatedMeal.mealSummarize}"/>
