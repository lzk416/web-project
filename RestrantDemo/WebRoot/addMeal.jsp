		...
		<table width="90%" height="170" border="0" cellpadding="0"
			...
			<tr>
				...
				<s:form action="doAddMeal" method="post" enctype="multipart/form-date">
					<table align="center">
						<s:textfield name="meal.mealnName" lable="菜名"></s:textfield>
						<s:select list="meal.mealseries.seriesId" lable="菜系" list="#request.mealSerierList" listKey="seriesId" listValue="seriesName"></s:select>
						<s:textfield name="meal.mealSummarize" lable="摘要"></s:textfield>
						<s:textfield name="meal.mealnDescription" lable="介绍"></s:textfield>
						<s:textfield name="meal.mealPrice" lable="价格"></s:textfield>
						<s:file name="doc" lable="图片"/>
