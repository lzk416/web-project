			...
			<tr>
				...
				<td height="41" colspan="2" style="background-image:url(images/001.gif);" align="center">
					...
					<s:if test="#session.admin!=null">
						...
						<a href="/Restrant/toMangeMeal">管理餐品</a>
						<a href="/Restrant/toMangeOrders">订单管理</a>
						<a href="/Restrant/logOut?type=adminLogout"> 注销</a>&nbsp;&nbsp; &nbsp;&nbsp;
						<font style="color: red"> 欢迎你：${sessionScope.admin.trueName}</font> 
					</s:if>
				</td>
			</tr>
			<tr>
				...
				<td valign="top" width="80%">
					...
					<table cellpadding="5" cellspacing="1" style="font-size:12px">
					      <s:iterator id="mealItem" value="#request.mealList" status="st">
					      		<s:if test="st.getIndex()%3==0"><!-- status.getIndex用于返回当前的索引，在本例子中用于每三行换行一次 -->
					      			<tr>
					      		</s:if>
					      			<td>
								...
								<td>
									<div>
										${ mealItem.mealId}  <!--显示商品的序号和名称  -->
										:
										${ mealItem.mealName}
										<br/>
										<span style="text-decoration:line-through; color:gray;">原价：人名币${ mealItem.mealPrice}元</span>
										<br />
										现价： 人民币
					      ...
					      <tr>
					      	...
					      	<td width="80">
					      		<s:if test="pager.curPage>1">
					      			<a href="/Restrant/toShowMeal?page.curPage=1&meal.mealseries.seriesId=${requestScope.seriesId}&meal.mealName=${requestScope.mealName}">首页</a>&nbsp;&nbsp;
					      			<a href="/Restrant/toShowMeal?page.curPage=${pager.curPage-1 }&meal.mealseriesId=${requestScope.seriesId}&meal.mealName=${requesrScope.mealName}">上一页</a>
					      		</s:if>
					      	</td>
					      	<td width="80">
							...
							<td>共${pager.rowCount}记录，共${pager.curPage}/${pager.pageCount}页</td>
					      </tr>
					</table>
				</td>
			</tr>
